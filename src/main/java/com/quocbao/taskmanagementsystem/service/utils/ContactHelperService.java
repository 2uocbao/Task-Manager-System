...
public class ContactHelperService {
	...
	public ContactHelperService(ContactRepository contactRepository) {
		this.contactRepository = contactRepository;
	}

	public Boolean isConnected(Long userId, Long userId1) {
		Specification<Contacts> specification = Specification.where(
				(ContactSpecification.findContactByUserId(userId)
						.and(ContactSpecification.findContactReceive(userId1)))
						.or(ContactSpecification.findContactByUserId(userId1)
